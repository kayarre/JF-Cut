...
#ifndef QHOVERPOINTS_H
#define QHOVERPOINTS_H
...
class QHoverPoints : public QObject
{
    Q_OBJECT
...
public:
    ...
    QHoverPoints(QWidget *widget, PointShape shape);
...
signals:
    void signalPointsChanged(QPolygonF);
    void signalPointsChanged();

public:
    void firePointChange();
    void load(const std::string &filePath, const QSize &size);
    void save(const std::string &filePath, const QSize &size);
...
inline QRectF QHoverPoints::pointBoundingRect(int i) const
{
...
inline QRectF QHoverPoints::boundingRect() const
{
    if (m_bounds.isEmpty())
